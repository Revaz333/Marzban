<p align="center">
  <a href="https://github.com/revaz333/marzban" target="_blank" rel="noopener noreferrer">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://github.com/revaz333/Marzban-docs/raw/master/screenshots/logo-dark.png">
      <img width="160" height="160" src="https://github.com/revaz333/Marzban-docs/raw/master/screenshots/logo-light.png">
    </picture>
  </a>
</p>
...
<p align="center">
    <a href="#">
        <img src="https://img.shields.io/github/actions/workflow/status/revaz333/marzban/build.yml?style=flat-square" />
    </a>
    <a href="https://hub.docker.com/r/revaz333/marzban" target="_blank">
        <img src="https://img.shields.io/docker/pulls/revaz333/marzban?style=flat-square&logo=docker" />
    </a>
    <a href="#">
        <img src="https://img.shields.io/github/license/revaz333/marzban?style=flat-square" />
    </a>
    <a href="https://t.me/revaz333_marzban" target="_blank">
    ...
    <a href="#">
        <img src="https://img.shields.io/github/stars/revaz333/marzban?style=social" />
    </a>
</p>
...
<p align="center">
  <a href="https://github.com/revaz333/marzban" target="_blank" rel="noopener noreferrer" >
    <img src="https://github.com/revaz333/Marzban-docs/raw/master/screenshots/preview.png" alt="Marzban screenshots" width="600" height="auto">
  </a>
</p>
...
```bash
sudo bash -c "$(curl -sL https://github.com/revaz333/Marzban-scripts/raw/master/marzban.sh)" @ install
```

Run the following command to install Marzban with MySQL database:

```bash
sudo bash -c "$(curl -sL https://github.com/revaz333/Marzban-scripts/raw/master/marzban.sh)" @ install --database mysql
```

Run the following command to install Marzban with MariaDB database:
```bash
sudo bash -c "$(curl -sL https://github.com/revaz333/Marzban-scripts/raw/master/marzban.sh)" @ install --database mariadb
```
...
- For security reasons, the Marzban dashboard is not accessible via IP address. Therefore, you must [obtain SSL certificate](https://revaz333.github.io/marzban/en/examples/issue-ssl-certificate) and access your Marzban dashboard by opening a web browser and navigating to `https://YOUR_DOMAIN:8000/dashboard/` (replace YOUR_DOMAIN with your actual domain)
...
```bash
git clone https://github.com/revaz333/Marzban.git
cd Marzban
...
The [Marzban Documentation](https://revaz333.github.io/marzban) provides all the essential guides to get you started, available in three languages: Farsi, English, and Russian. This documentation requires significant effort to cover all aspects of the project comprehensively. We welcome and appreciate your contributions to help us improve it. You can contribute on this [GitHub repository](https://github.com/revaz333/revaz333.github.io).
...
```bash
sudo bash -c "$(curl -sL https://github.com/revaz333/Marzban-scripts/raw/master/marzban.sh)" @ install-script
```
...
We ❤️‍🔥 contributors! If you'd like to contribute, please check out our [Contributing Guidelines](CONTRIBUTING.md) and feel free to submit a pull request or open an issue. We also welcome you to join our [Telegram](https://t.me/revaz333_marzban) group for either support or contributing guidance.

Check [open issues](https://github.com/revaz333/marzban/issues) to help the progress of this project.

<p align="center">
Thanks to the all contributors who have helped improve Marzban:
</p>
<p align="center">
<a href="https://github.com/revaz333/Marzban/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=revaz333/Marzban" />
</a>
</p>
<p align="center">
